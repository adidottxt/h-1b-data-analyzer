...
/**
 * This class implements the alert box that forces users to pick a city
 * for any questions that require the user to input a city. By asking the
 * user to pick from the top ~100-150 cities, we're also (for the most part) 
 * reducing the chance of a city that didn't have any applications to be picked.
 * @author adi
 *
 */
