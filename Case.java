...
public class Case {
    ...
    int caseSubmitDateMonth;
    int caseSubmitDateDay;
    int caseSubmitDateYear;
    ...
    public Case (String[] row, int year) {
        ...
        if (year == 2008) {
            ...
            if (row[0] != null) {
              String[] caseSubmitDate = row[0].split("/");
              caseSubmitDateMonth = Integer.parseInt(caseSubmitDate[0].trim());
              caseSubmitDateDay = Integer.parseInt(caseSubmitDate[1].trim());
            ...
            if (row[9] != null) {
                employerPostalCode = row[9].toString();
            }
            ...
            if (employerCity.equals("CITY") || employerCity.equals("CITY:")) {
                ...
                if (row[2] != null) {
                    String[] caseSubmitDate = row[2].split("/");
                    caseSubmitDateMonth = Integer.parseInt(caseSubmitDate[0].trim());
                    caseSubmitDateDay = Integer.parseInt(caseSubmitDate[1].trim());
                    caseSubmitDateYear = Integer.parseInt(caseSubmitDate[2].trim());
                  }
                ...
                if (row[11] != null) {
                    employerPostalCode = row[11].toString();
                }
            ...
            if (row[12] != null) {
                employerPostalCode = row[12].toString();
            }
            ...
            if (row[39] != null) {
                worksitePostalCode = row[39].toString();
            }
            ...
            if (row[38] != null) {
                worksitePostalCode = row[38].toString();
            }
            ...
            if (row[50] != null) {
                worksitePostalCode = row[50].toString();
            }
